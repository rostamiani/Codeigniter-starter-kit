...
class Jalali
{
	...
	// Convert Mysql DateTime to Jalali Date
	...
	public function gregorian_to_jalali($g_y, $g_m, $g_d,$str)
	{
	   ...
	   $jm = $i+1;
	   $jd = $j_day_no+1;
	 if($str) return $jy.$str.$jm.$str.$jd ;
	...
	public function jalali_to_gregorian($j_y, $j_m, $j_d,$str)
	{
	   ...
	   $gm = $i+1;
	   $gd = $g_day_no+1;
	    if($str) return $gy.$str.$gm.$str.$gd ;
...
/* End of file LCustom */
/* Location: ./application/libraries/LCustom */